...
class Detail extends React.Component {
  ...
  booking = (e) => {
    ...
    const booking = TransactionModel.booking(
      this.props.match.params.id,
      this.state
    );
    booking
      .then((res) => {
        Swal.fire("Success", "Booking success", "success").then(() => {
          this.props.history.push("/dashboard/catalog");
        });
      })
      .catch((rej) => {
        Swal.fire("Failed", rej.response.data.msg, "error");
      });
  };
  ...
  findBook = () => {
    ...
    book
      ...
      .catch((rej) => {
        Swal.fire("Failed to get book", rej.response.data.msg, "error").then(
          () => {
            this.props.history.push("/dashboard/catalog");
          }
        );
      ...
      <div className="container-fluid p-0 mb-5">
              ...
              <form onSubmit={this.updateBook} method="post">
                ...
                <div className="form-group">
                  ...
                  <Select
                    ...
                    defaultValue={{
                      label: this.state.genres.filter((val, index) => {
                        return this.state.genre_id === val.id;
                      })[0].name,
                ...
                <div className="form-group">
                  ...
                  <Select
                    ...
                    className="flex-grow-1"
                    defaultValue={{
                      label: this.state.authors.filter((val, index) => {
                        return this.state.author_id === val.id;
                      })[0].name,
                ...
                <div className="form-group w-100 d-flex justify-content-center">
                  {(this.state.file.length > 0 || this.state.detail.image) && (
                    <img
                      src={
        ...
        <div
          ...
          style={{
            ...
            backgroundImage: `url(${this.state.detail.image})`,
          }}
        >
          <div className="position-absolute p-3 d-flex flex-row w-100 justify-content-between align-items-center">
            ...
            {localStorage.getItem("session_user") &&
              (JSON.parse(localStorage.getItem("session_user")).role ===
                "Super Admin" ||
                JSON.parse(localStorage.getItem("session_user")).role ===
                  "Admin") && (
