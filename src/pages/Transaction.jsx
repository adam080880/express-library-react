...
class Transaction extends React.Component {
  ...
  fetchAdmin = (param) => {
    ...
    TransactionModel.adminTransaction(param)
      .then((res) => {
        this.setState({
  ...
  fetchMember = (param) => {
    ...
    TransactionModel.memberTransaction(param)
      .then((res) => {
        this.setState({
          histories: res.data.data,
          pageInfo: res.data.pageInfo,
          ...
          <div className="d-flex flex-column flex-lg-row align-items-center px-4 pb-0 mt-3 justify-content-between">
            ...
            <div className="control d-flex align-items-center">
              <form
                ...
                onSubmit={this.searchAdmin}
              >
                <input
                  type="search"
                  onChange={(e) =>
                    this.setState({ searchAdmin: e.target.value })
                  }
                ...
                <div className="dropdown ml-2 mr-0">
                  <button
                    className="btn btn-outline-secondary d-flex flex-row align-items-center dropdown-toggle"
                    type="button"
                        ...
                        <>
                          ...
                          <div className="w-100 d-flex justify-content-between">
                            <button
                              ...
                              onClick={() => {
                                this.props.history.push(
                                  `/dashboard/history?${qs.stringify({
                                    ...params,
                            ...
                            <div className="pagination-">
                              {[...Array(this.state.pageInfo.totalPage)].map(
                                (a, index) => (
                                  <button
                            ...
                            <button
                              className="d-inline-flex btn btn-outline-secondary"
                              disabled={
                                params.page >= this.state.pageInfo.totalPage
                                  ? true
                                  : false
                              }
                              onClick={() => {
