...
class Dashboard extends React.Component {
  ...
  completeRegis = (e) => {
    ...
    complete
      .then((res) => {
        Swal.fire("Complete", "Redirect to Login", "success").then(() => {
  ...
  renderGenre = (val, index) => <option value={val.id}>{val.name}</option>;

  renderAuthor = (val, index) => <option value={val.id}>{val.name}</option>;
        ...
        <>
                ...
                <ModalBody>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      placeholder="name"
                      onChange={(e) => {
                        this.setState({ nameRegis: e.target.value });
                      }}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className="form-control"
                      onChange={(e) => {
                        this.setState({ birthRegis: e.target.value });
                      }}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      id="phone"
                      onChange={(e) => {
                        this.setState({ phoneRegis: e.target.value });
                      }}
                      className="form-control"
                      placeholder="phone"
                    />
                  ...
                  <div
                    ...
                    onChange={(e) => {
                      this.setState({ genderRegis: e.target.value });
                    }}
                  >
              ...
              <form method="post" onSubmit={this.submitForm}>
                <ModalBody>
                  ...
                  <div className="form-group">
                    ...
                    <Select
                      onChange={(value) =>
                        this.setState({ genre_id: value.value })
                      }
                      className="flex-grow-1"
                      placeholder="Choose a genre"
                      options={this.state.genres.map((val) =>
                        Object({ value: val.id, label: val.name })
                      )}
                    />
                  </div>
                  <div className="form-group">
          ...
          <div className="container-fluid px-0">
            ...
            >
              ...
              {this.state.session_user && this.state.session_user.name && (
                <div className="d-flex align-items-center flex-column flex-grow-1 text-center justify-content-center">
              ...
              {this.state.session_user &&
                (this.state.session_user.role.toLowerCase() === "super admin" ||
                  this.state.session_user.role.toLowerCase() === "admin") && (
                  <div className="d-flex align-items-center flex-column justify-content-center flex-grow-1 text-center">
                    <Link
                      to="#"
                      onClick={(e) => {
            ...
            <Row className="dashboard mx-0">
              <div
                className="sidebar text-white sticky-top"
                  ...
                  <div className="p-3 flex-grow-1 d-flex flex-column justify-content-center mb-5 pb-5">
                    ...
                    <div className="mt-3 ml-0 mb-5">
                      <div className="nav pl-0 flex-column sidebar-menu">
                        ...
                        {this.state.session_user &&
                          (this.state.session_user.role.toLowerCase() ===
                            "super admin" ||
                            this.state.session_user.role.toLowerCase() ===
                              "admin") && (
                            <div className="nav-item">
